...
pi-gen/1.0.29 darwin-x64 node-v10.11.0
$ pi-gen --help [COMMAND]
USAGE
  $ pi-gen COMMAND
...
...
_See code: [src/commands/build.ts](https://github.com/gseregni/pi-gen/blob/v1.0.29/src/commands/build.ts)_
...
_See code: [src/commands/compile.ts](https://github.com/gseregni/pi-gen/blob/v1.0.29/src/commands/compile.ts)_
...
_See code: [src/commands/serve.ts](https://github.com/gseregni/pi-gen/blob/v1.0.29/src/commands/serve.ts)_
<!-- commandsstop -->
